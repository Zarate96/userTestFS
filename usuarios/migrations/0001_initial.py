    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('penalizaciones', models.IntegerField(default=0, verbose_name='Número de penalizacionos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('carrier', models.CharField(choices=[('Telcel', 'Telcel'), ('Movistar', 'Movistar'), ('Unefón', 'Unefón'), ('AT&T México', 'AT&T México'), ('Altán Redes', 'Altán Redes')], max_length=50, verbose_name='Nombre de la compañia')),
                ('mcc', models.IntegerField(verbose_name='Mobile Country Code')),
                ('mnc', models.CharField(max_length=5, verbose_name='Home MobileNetwork Code')),
                ('radioType', models.CharField(choices=[('gsm', 'gsm'), ('lte', 'lte')], max_length=15, verbose_name='Tipo de radio')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, null=True)),
                ('telefonia_movil', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuarios.telefonias')),
            ],
        ),
    ]
