# Generated by Django 3.2 on 2022-06-13 23:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('licencia_conducir', models.CharField(default='', max_length=50, verbose_name='Licencia de conducir')),
                ('licencia_conducir_foto', models.ImageField(upload_to='licencias_transportistas', verbose_name='Foto de licencia de conducir')),
                ('fecha_vencimiento', models.DateTimeField(blank=True, default=None, null=True, verbose_name='Fecha de vencimiento de la licencia de manejo')),
                ('slug', models.SlugField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
