# Generated by Django 3.2 on 2022-04-29 19:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, null=True)),
                ('cliente_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuarios.cliente')),
            ],
        ),
        migrations.CreateModel(
            name='Orden',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_viaje', models.CharField(choices=[('Creado', 'Creado'), ('Iniciado', 'Iniciado'), ('Cerrado', 'Cerrado'), ('Terminado', 'Terminado'), ('Disputa', 'Disputa'), ('Accidente', 'Accidente')], default='Creado', max_length=40, verbose_name='Estado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_solicitud', models.CharField(choices=[('Guardada', 'Guardada'), ('Publicada', 'Publicada'), ('Cotizada', 'Cotizada'), ('Asignada', 'Asignada'), ('Cancelada', 'Cancelada')], default='Guardada', max_length=40, verbose_name='Estado de la solicitud')),
                ...
                ('activo', models.BooleanField(default=True, verbose_name='Activo')),
                ('cliente_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuarios.cliente')),
                ('domicilio_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='fletes.domicilios', verbose_name='Origen')),
            ],
        ),
        migrations.CreateModel(
            name='Destino',
            fields=[
                ...
                ('domicilio_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='fletes.domicilios')),
                ('solicitud_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fletes.solicitud')),
            ],
        ),
        migrations.AddField(
