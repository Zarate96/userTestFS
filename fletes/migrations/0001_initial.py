    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_cotizacion', models.CharField(choices=[('Enviada', 'Enviada'), ('Aceptada', 'Aceptada'), ('Rechazada', 'Rechazada'), ('Confirmada', 'Confirmada')], default='Enviada', max_length=40, verbose_name='Estado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_solicitud', models.CharField(choices=[('Guardada', 'Guardada'), ('Publicada', 'Publicada'), ('Cotizada', 'Cotizada')], default='Guardada', max_length=40, verbose_name='Estado')),
                ('slug', models.SlugField(blank=True, null=True)),
            ],
        ),
    ]
